...
5. **Self-contained body** — Cold reader gets Why, Scope, How, Lineage. Prefer `references/templates/pr-body.md`. Not "as discussed" alone.
...
10. **Progress comments** — Multi-commit milestones → `references/templates/pr-progress-comment.md`; skip typo-only pushes.
