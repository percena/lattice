...
# ---------------------------------------------------------------------------
# L3-status-row guard (spc-337 A4 / ADR-012 §2) — extracted to lib/
# ---------------------------------------------------------------------------
_HOOK_DIR_FOR_LIB="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# shellcheck source=lib/status-row-guard.sh
source "$_HOOK_DIR_FOR_LIB/lib/status-row-guard.sh"
